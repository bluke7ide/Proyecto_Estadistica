...
También se imprime el plot de correlaciones, ya que las dimensiones de LaTex limitan la posibilidad de utilizar la matriz numerica.
```{r, message=FALSE}
...
corrplot(Correlacion, method = "circle", tl.cex = 0.5)
```
